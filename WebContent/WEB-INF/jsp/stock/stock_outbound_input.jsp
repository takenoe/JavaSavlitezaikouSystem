	...
	<form method="post" action="confirm">
		<div>
			...
			<ul>
				<li>
				<label>
					<span>商品コード</span> <input type="text" name="code" placeholder="数字を入力" />
				</label>
				</li>
				<li>
				<label>
					<span>数量</span> <input type="text" name="quantity" placeholder="数字を入力" />
				</label>
				</li>
			</ul>
			<br> <input type="submit" value="確認" /><br> <br> <a
